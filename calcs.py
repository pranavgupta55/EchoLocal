...
def createRadialGradientSurface(pygame, finalSize=(512, 512), circularSmoothnessSteps=3, starterSize=(3, 3),
                                baseColor=(0, 0, 0, 200), centerColor=(180, 30, 255, 255)):
    """
    ...
    pygame.draw.circle(tempSurface, baseColor, (tempSurface.get_width() / 2, tempSurface.get_width() / 2),
                       tempSurface.get_width(), int(tempSurface.get_width() / 2))
